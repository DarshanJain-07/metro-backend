...
router.register(
    r"permission-catalog", PermissionCatalogViewSet, basename="permission-catalog"
)
...
router.register(
    r"company-role-permissions",
    CompanyRolePermissionViewSet,
    basename="company-role-permission",
)
router.register(
    r"company-role-overrides",
    CompanyRolePermissionOverrideViewSet,
    basename="company-role-override",
)
...
urlpatterns = [
    ...
    path(
        "login/mfa/challenge/", MfaChallengeView.as_view(), name="login_mfa_challenge"
    ),
    ...
    path(
        ...
        name="login_organization_select",
    ),
