...
master_import_file = MasterDataViewSet.as_view({"post": "import_file"})
master_import_rows = MasterDataViewSet.as_view({"post": "import_rows"})
master_export_file = MasterDataViewSet.as_view({"get": "export_file"})
...
urlpatterns = [
    ...
    path("api/v1/master/<str:resource>/import-file/", master_import_file, name="master-import-file"),
    path("api/v1/master/<str:resource>/import-rows/", master_import_rows, name="master-import-rows"),
    path("api/v1/master/<str:resource>/export/", master_export_file, name="master-export-file"),
